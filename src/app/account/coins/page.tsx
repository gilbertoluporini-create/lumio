...
const REASON_META: Record<string, { label: string; icon: ReasonIcon }> = {
  ...
  summary_with_images: { label: "Resumo com ilustrações", icon: ImageIcon },
  flashcards: { label: "Deck de flashcards", icon: Layers },
  quiz: { label: "Quiz de revisão", icon: HelpCircle },
  mindmap: { label: "Mapa mental", icon: Network },
  voice_reply: { label: "Resposta por voz", icon: Mic },
  image_generation: { label: "Ilustrações geradas", icon: ImageIcon },
